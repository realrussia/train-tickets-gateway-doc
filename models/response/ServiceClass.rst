...
#.  float **price_for_child** This tag is optional. It will be shown only for InformationController::getTrain. NOTE: this is approximate price, accurate price will be shown only in `TicketsController.bookTickets </controllers/TicketsController.rst#booktickets>`_;
